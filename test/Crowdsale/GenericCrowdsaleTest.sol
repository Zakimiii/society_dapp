...
import "../../contracts/01-generic/SocietyCrowdsale.sol";


contract SocietyCrowdsaleTest {
  SocietyCrowdsale crowdsale;
  SocietyToken token;
  ...
  function beforeEach() public {
    token = new SocietyToken("Tooploox", "TPX", DECIMAL_PLACES, TOTAL_SUPPLY);
    crowdsale = new SocietyCrowdsale(openingTime, closingTime, RATE, address(this), token);
  }
