...
import "../../contracts/Vesting/SocietyTokenVesting.sol";


contract SocietyTokenVestingTest {
  SocietyTokenVesting vesting;
  ...
  function beforeEach() public {
    vesting = new SocietyTokenVesting(beneficiary, start, cliff, duration, revocable);
  }
